...
var FastBase64 = {
    ...
    encode: function(src) {
        ...
        while(len > 2){
            ...
            s += encLookup[n >> 12] + encLookup[n & 0xFFF];
            len -= 3;
            i += 3;
        }
        if(len > 0){
...
var RIFFWAVE = function(data, sampleRate, bitsPerSample) {
    ...
    this.dataURI = 'data:audio/wav;base64,' + FastBase64.encode(wav);

    console.log(FastBase64.encode(wav) === btoa(wav));
